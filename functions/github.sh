...
# github 프로젝트 디렉토리로 이동 (경로에 $script_dir/.. 추가)
cd "$script_dir/../${terraform_root}/github" || { echo "Error: github 디렉토리를 찾을 수 없습니다."; cd "$initial_dir"; exit 1; }
...
echo "github 프로젝트에 대해 terraform $action 완료"
